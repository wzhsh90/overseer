...
[![GoDoc](https://godoc.org/github.com/wzhsh90/overseer?status.svg)](https://godoc.org/github.com/wzhsh90/overseer)   [![Tests](https://github.com/wzhsh90/overseer/workflows/Tests/badge.svg)](https://github.com/wzhsh90/overseer/actions?workflow=Tests)
...
```sh
go get github.com/wzhsh90/overseer
```
...
import (
	...
	"github.com/wzhsh90/overseer"
	"github.com/wzhsh90/overseer/fetcher"
)
...
See [Config](https://godoc.org/github.com/wzhsh90/overseer#Config)uration options [here](https://godoc.org/github.com/wzhsh90/overseer#Config) and the runtime [State](https://godoc.org/github.com/wzhsh90/overseer#State) available to your program [here](https://godoc.org/github.com/wzhsh90/overseer#State).
...
* [Core `overseer` package](https://godoc.org/github.com/wzhsh90/overseer)
* [Common `fetcher.Interface`](https://godoc.org/github.com/wzhsh90/overseer/fetcher#Interface)
	* [File fetcher](https://godoc.org/github.com/wzhsh90/overseer/fetcher#File)
	* [HTTP fetcher](https://godoc.org/github.com/wzhsh90/overseer/fetcher#HTTP)
	* [S3 fetcher](https://godoc.org/github.com/wzhsh90/overseer/fetcher#S3)
	* [Github fetcher](https://godoc.org/github.com/wzhsh90/overseer/fetcher#Github)
